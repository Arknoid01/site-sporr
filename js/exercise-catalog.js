...
const EXERCISE_CATALOG = [
  ...
  { id: 'crunch', name: 'Crunch', muscle: 'abdos', equipment: 'none',
    ...
    tips: ['Regard vers le plafond', 'Expire en montant', 'Ne tire pas sur la nuque'], defaultMode: 'reps', defaultValue: 15 },
  { id: 'gainage', name: 'Gainage planche', muscle: 'abdos', equipment: 'none',
    desc: 'Appui avant-bras et orteils, corps aligné de la tête aux talons.',
    tips: ['Fessiers serrés', 'Ne creuse pas le dos', 'Respiration régulière'], defaultMode: 'time', defaultValue: 30 },
  { id: 'mountain', name: 'Mountain Climbers', muscle: 'abdos', equipment: 'none',
    ...
    tips: ['Hanches basses', 'Rythme régulier', 'Core engagé'], defaultMode: 'time', defaultValue: 30 },
  { id: 'gainage-lateral', name: 'Gainage latéral', muscle: 'abdos', equipment: 'none',
    desc: 'Sur le côté, appui avant-bras, hanches levées, corps aligné.',
    tips: ['Hanches hautes', 'Ne te laisse pas affaisser', 'Respire'], defaultMode: 'time', defaultValue: 25 }
];
